...
ManagementController.Management = {
    ...
    getIssueReports: async (req, res) => {
        managementMiddleware.Management.getIssueReports(req)
        .then((data) => {
            const response = ApplicationResult.forCreated();
            var statuscode = 0;
            ApplicationResponse.success(
    ...
    createColor: async (req, res) => {
        managementMiddleware.Management.createColor(req)
        .then((data) => {
            const response = ApplicationResult.forCreated();
            var statuscode = 0;
            ApplicationResponse.success(
    ...
    createIllustration: async (req, res) => {
        managementMiddleware.Management.createIllustration(req)
        .then((data) => {
            const response = ApplicationResult.forCreated();
            var statuscode = 0;
            ApplicationResponse.success(
    ...
    createBannerCharge: async (req, res) => {
        managementMiddleware.Management.createBannerCharge(req)
        .then((data) => {
            const response = ApplicationResult.forCreated();
            var statuscode = 0;
            ApplicationResponse.success(
    ...
    fetchColors: async (req, res) => {
        managementMiddleware.Management.fetchColors(req)
        .then((data) => {
            const response = ApplicationResult.forCreated();
            var statuscode = 0;
            ApplicationResponse.success(
    ...
    deleteColor: async (req, res) => {
        managementMiddleware.Management.deleteColor(req)
        .then((data) => {
            const response = ApplicationResult.forCreated();
            var statuscode = 0;
            ApplicationResponse.success(
    ...
    fetchIllustrations: async (req, res) => {
        managementMiddleware.Management.fetchIllustrations(req)
        .then((data) => {
            const response = ApplicationResult.forCreated();
            var statuscode = 0;
            ApplicationResponse.success(
    ...
    deleteIllustration: async (req, res) => {
        managementMiddleware.Management.deleteIllustration(req)
        .then((data) => {
            const response = ApplicationResult.forCreated();
            var statuscode = 0;
            ApplicationResponse.success(
    ...
    fetchBannerCharges: async (req, res) => {
        managementMiddleware.Management.fetchBannerCharges(req)
        .then((data) => {
            const response = ApplicationResult.forCreated();
            var statuscode = 0;
            ApplicationResponse.success(
    ...
    deleteBannerCharge: async (req, res) => {
        managementMiddleware.Management.deleteBannerCharge(req)
        .then((data) => {
            const response = ApplicationResult.forCreated();
            var statuscode = 0;
            ApplicationResponse.success(
    ...
    addBackgroundImage: async (req, res) => {
        managementMiddleware.Management.addBackgroundImage(req)
        .then((data) => {
            const response = ApplicationResult.forCreated();
            var statuscode = 0;
            ApplicationResponse.success(
    ...
    fetchBackgroundImage: async (req, res) => {
        managementMiddleware.Management.fetchBackgroundImage(req)
        .then((data) => {
            const response = ApplicationResult.forCreated();
            var statuscode = 0;
            ApplicationResponse.success(
    ...
    deleteBackgroundImage: async (req, res) => {
        managementMiddleware.Management.deleteBackgroundImage(req)
        .then((data) => {
            const response = ApplicationResult.forCreated();
            var statuscode = 0;
            ApplicationResponse.success(
